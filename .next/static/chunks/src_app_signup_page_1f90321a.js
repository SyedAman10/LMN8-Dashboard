...
function SignupPage() {
    _s();
    const { signup, isAuthenticated, loading: authLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$AuthContext$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SignupPage.useEffect": ()=>{
            ...
            return ({
                "SignupPage.useEffect": ()=>window.removeEventListener('mousemove', handleMouseMove)
            })["SignupPage.useEffect"];
        }
    }["SignupPage.useEffect"], []);
...
_s(SignupPage, "vbLlX1+6gy4hrmY4FnqVcApn1V0=", false, function() {
    return [
...
//# sourceMappingURL=src_app_signup_page_1f90321a.js.map