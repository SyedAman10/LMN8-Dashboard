...
class DatabaseDebug {
    ...
    static async forceReset() {
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$database$2f$indexeddb$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["IndexedDBService"].forceReset();
...
if ("TURBOPACK compile-time truthy", 1) {
    ...
    console.log('  - DatabaseDebug.forceReset() - Force reset (delete & recreate)');
}
...
"[project]/src/components/DatabaseStatus.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function DatabaseStatus() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DatabaseStatus.useEffect": ()=>{
            const loadStats = {
                "DatabaseStatus.useEffect.loadStats": async ()=>{
                    const result = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$database$2f$debug$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DatabaseDebug"].getStats();
                    if (result.success) {
                        setStats(result.stats);
                    }
                }
            }["DatabaseStatus.useEffect.loadStats"];
            loadStats();
        }
    }["DatabaseStatus.useEffect"], []);
    const handleClearData = async ()=>{
        if (confirm('Are you sure you want to clear all local data? This cannot be undone.')) {
            const result = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$database$2f$debug$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DatabaseDebug"].clearLocalData();
            if (result.success) {
    ...
    const handleReset = async ()=>{
        if (confirm('Are you sure you want to reset the database? This will clear all local data and reinitialize.')) {
            const result = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$database$2f$debug$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DatabaseDebug"].reset();
            if (result.success) {
    ...
    const handleForceReset = async ()=>{
        if (confirm('Are you sure you want to FORCE reset the database? This will completely delete and recreate the database. This is more aggressive and should fix constraint errors.')) {
            const result = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$database$2f$debug$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DatabaseDebug"].forceReset();
            if (result.success) {
...
_s(DatabaseStatus, "9pBB1SmUfr8GeybYYYt7OVNgPEk=");
_c = DatabaseStatus;
var _c;
...
//# sourceMappingURL=src_6481bf55._.js.map