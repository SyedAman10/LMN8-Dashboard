...
"[project]/src/lib/auth/authService.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class AuthService {
    ...
    static async hashPassword(password) {
        try {
            const saltRounds = 12;
            return await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$bcryptjs$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].hash(password, saltRounds);
        } catch (error) {
    ...
    static async verifyPassword(password, hash) {
        try {
            return await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$bcryptjs$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].compare(password, hash);
        } catch (error) {
    ...
    static async signUp(userData) {
        try {
            ...
            const existingUser = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$database$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DatabaseService"].getUserByEmail(email);
            if (existingUser) {
            ...
            const user = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$database$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DatabaseService"].createUser(newUserData);
            // Generate session token
    ...
    static async signIn(email, password) {
        try {
            ...
            const user = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$database$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DatabaseService"].getUserByEmail(email);
            if (!user) {
    ...
    static async updateProfile(userId, updateData) {
        try {
            const updatedUser = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$database$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DatabaseService"].updateUser(userId, updateData);
    ...
    static async changePassword(userId, currentPassword, newPassword) {
        try {
            // Get current user
            const user = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$database$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DatabaseService"].getUserById(userId);
            if (!user) {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$database$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DatabaseService"].updateUser(userId, {
    ...
    static async refreshSession() {
        try {
            ...
            const user = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$database$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DatabaseService"].getUserById(session.user.id);
            if (!user) {
                this.clearSession();
                return false;
            }
...
"[project]/src/lib/auth/index.js [app-ssr] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([]);
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2f$authService$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/auth/authService.js [app-ssr] (ecmascript)");
;
;
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/src/lib/auth/index.js [app-ssr] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2f$authService$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/auth/authService.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$database$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/database/index.js [app-ssr] (ecmascript)");
'use client';
;
...
function SignupPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        if (__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2f$authService$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["AuthService"].isAuthenticated()) {
    ...
    const handleSubmit = async (e)=>{
        ...
        setErrors({});
        try {
            const result = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2f$authService$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["AuthService"].signUp({
                                                    ...
                                                    children: [
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            ...
                                                            children: [
                                                                ...
                                                                formData.role === 'clinician' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c4e906cd._.js.map