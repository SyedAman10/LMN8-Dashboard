...
async function GET(request) {
    try {
        ...
        const activePatientsResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`SELECT COUNT(*) as count 
       FROM patients 
       WHERE user_id = $1 AND status = 'active'`, [
        ...
        const totalPatientsResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`SELECT COUNT(*) as count 
       FROM patients 
       WHERE user_id = $1`, [
            user.id
        ]);
        ...
        const completionRateResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`SELECT 
       ...
       WHERE user_id = $1`, [
        ...
        const recentPatientsResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`SELECT id, name, diagnosis, sessions_completed, total_sessions, status, created_at
       FROM patients 
       WHERE user_id = $1 
       ...
       LIMIT 5`, [
        ...
        const patientsByStatusResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`SELECT status, COUNT(*) as count
       FROM patients 
       WHERE user_id = $1 
       GROUP BY status`, [
            user.id
        ...
        const avgSessionsResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`SELECT AVG(sessions_completed) as avg_completed, AVG(total_sessions) as avg_total
       FROM patients 
       WHERE user_id = $1`, [
            user.id
        ]);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__8d2aac11._.js.map